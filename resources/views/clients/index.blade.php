            ...
            <div class="row">
                <div class="col-xs-7 col-sm-5 col-lg-8">
                    <h1 class="page-title txt-color-blueDark">
                        ...
                        {{ trans('lang.client') }}  {{ trans('lang.management') }}
                    </h1>
                </div>
                <div class="col-xs-5 col-sm-7 col-lg-4 padding-10">
                    <a href="#" ajax_target="clients/create" class="btn btn-success pull-right remote_modal">
                        <i class="fa fa-plus"></i> {{trans('lang.add_client')}}
                    </a>
                </div>
            </div>
            <!-- widget grid -->
                                ...
                                <div class="widget-body no-padding">
                                    <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%" style="margin-top:0 !important;">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hasinput smart-form">
                                                <label class="select">
                                                    <select name="status" >
                                                        <option value=""
                                                                selected="selected">{{ trans('lang.select_client_category') }}</option>
                                                        @foreach(\App\Models\Clients::$client_status as $key => $status)
                                        ...
                                        <tr>
                                            ...
                                            <th data-class="expand">{{ trans('lang.first_name') }}</th>
                                            <th data-hide="phone,tablet">{{ trans('lang.last_name') }}</th>
                                            <th data-hide="phone,tablet" >{{ trans('lang.email') }}</th>
                                            <th data-hide="phone,tablet" >{{ trans('lang.status') }}</th>
                                            <th  data-hide="phone,tablet">{{ trans('lang.client_price') }}</th>
