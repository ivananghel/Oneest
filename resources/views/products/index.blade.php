            ...
            <div class="row">
                <div class="col-xs-7 col-sm-5 col-lg-8">
                    <h1 class="page-title txt-color-blueDark">
                        ...
                        {{ trans('lang.products') }}  {{ trans('lang.management') }}
                    </h1>
                </div>
                <div class="col-xs-5 col-sm-7 col-lg-4 padding-10">
                    <a href="#" ajax_target="products/create" class="btn btn-success pull-right remote_modal">
                        <i class="fa fa-plus"></i>  {{trans('lang.add')}} {{trans('lang.products')}}
                    </a>
                </div>
            </div>
            <!-- widget grid -->
                                ...
                                <div class="widget-body no-padding">
                                    <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%" style="margin-top:0 !important;">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hasinput" >
                                                <input type="text" class="form-control" placeholder="{{ trans('lang.title') }}" />
                                            </th>
                                            <th class="hasinput" >
                                                <input type="text" class="form-control" placeholder="{{ trans('lang.price') }}" />
                                            </th>
                                            <th class="hasinput" >
                                                <input type="text" class="form-control" placeholder="{{ trans('lang.amount') }}" />
                                            </th>
                                            ...
                                            <th class="hasinput smart-form">
                                                <label class="select">
                                                    <select name="stock" >
                                                        <option value=""
                                                                selected="selected">{{ trans('lang.stock') }}</option>
                                        ...
                                        <tr>
                                            ...
                                            <th data-class="expand">{{ trans('lang.title') }}</th>
                                            <th data-hide="phone,tablet">{{ trans('lang.price') }}</th>
                                            <th data-hide="phone,tablet" >{{ trans('lang.amount') }}</th>
                                            <th data-hide="phone,tablet" >{{ trans('lang.stock') }}</th>
